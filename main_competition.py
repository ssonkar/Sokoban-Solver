...
path=r"C:\Users\ARKADEEP\Desktop\ai proj\sokoban-master\competition_tests"+"//"
li=['00','01','02','03','04','05','06','07','08','09','10']
for i in li:
    lines = []                  # Declare an empty list named "lines"
    with open (path+'sokoban'+i+'.txt', 'rt') as in_file:  # Open file lorem.txt for reading of text data.
        print('\n\n Running sokoban'+i)
